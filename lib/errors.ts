...
const DEFAULT_ERROR_MESSAGES: Record<string, string> = {
  ...
  'error.guest_platform_unsupported': 'Guest analysis is not available on this platform right now. You can still record dreams locally.',
  'error.guest_quota_unavailable': 'Guest analysis is temporarily unavailable. You can still record dreams locally and try again later.',
