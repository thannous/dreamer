export const TID = {
  ...
  Button: {
    ...
    OnboardingCaptureMode: (id: string) => `btn.onboarding.captureMode.${id}`,
    OnboardingPrimary: 'btn.onboarding.primary',
    OnboardingFresh: 'btn.onboarding.fresh',
  ...
  Component: {
    ...
    OnboardingPathDetail: 'component.onboarding.pathDetail',
    OnboardingCapture: 'component.onboarding.capture',
