...
<h3 class="font-serif text-lg text-dream-cream">Sueños REM</h3>
</div>
...
<li><strong>Parálisis del sueño:</strong> Episodios frecuentes de parálisis REM al despertar o dormirse</li>
...
<section class="mt-12" aria-label="Navegación entre artículos" data-blog-nav="">
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <a href="por-que-sonamos-ciencia" class="glass-panel rounded-xl p-5 flex items-start gap-3 hover:border-dream-salmon/30 transition-all hover:-translate-y-1">
    ...
    <a href="historia-interpretacion-suenos" class="glass-panel rounded-xl p-5 flex items-start justify-between gap-3 hover:border-dream-salmon/30 transition-all hover:-translate-y-1">
      <div>
