---
{
  ...
  "jsonLd": [
    ...
    "{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"FAQPage\",\n  \"mainEntity\": [\n    {\n      \"@type\": \"Question\",\n      \"name\": \"Pourquoi je fais des cauchemars ?\",\n      \"acceptedAnswer\": {\n        \"@type\": \"Answer\",\n        \"text\": \"Les cauchemars peuvent être causés par le stress, l'anxiété, un traumatisme, certains médicaments, le manque de sommeil ou manger tard le soir. C'est souvent la façon dont votre cerveau traite les émotions difficiles. Environ 2 à 8% des adultes font des cauchemars fréquents.\"\n      }\n    },\n    {\n      \"@type\": \"Question\",\n      \"name\": \"Comment arrêter de faire des cauchemars ?\",\n      \"acceptedAnswer\": {\n        \"@type\": \"Answer\",\n        \"text\": \"Pour réduire les cauchemars : maintenez un horaire de sommeil régulier, pratiquez la gestion du stress, évitez les écrans avant le coucher, créez un environnement de sommeil calme, et essayez la Thérapie par Répétition d'Images (IRT) - une technique où vous réécrivez les fins de cauchemars en état d'éveil.\"\n      }\n    },\n    {\n      \"@type\": \"Question\",\n      \"name\": \"Les cauchemars ont-ils une signification ?\",\n      \"acceptedAnswer\": {\n        \"@type\": \"Answer\",\n        \"text\": \"Oui, les cauchemars reflètent souvent des anxiétés sous-jacentes, des émotions non traitées ou des sources de stress dans votre vie éveillée. Ils peuvent être votre subconscient mettant en lumière des problèmes qui nécessitent attention. Les thèmes courants concernent la peur de la perte, de l'échec ou de perdre le contrôle.\"\n      }\n    }\n  ]\n}",
...
<p class="text-sm text-gray-300">Une nuit chaude peut ajouter des réveils à cette tension. Le guide <a class="text-dream-salmon hover:underline" href="cauchemars-chaleur-stress">cauchemars, chaleur et stress</a> sépare le contexte physique du contenu du rêve.</p>
</div>
<div class="dream-card glass-panel rounded-xl p-6 border border-transparent">
<div class="flex items-center gap-3 mb-4">
<div class="p-2 bg-dream-salmon/10 rounded-lg">
