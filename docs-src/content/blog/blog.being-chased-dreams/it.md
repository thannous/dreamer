...
<section class="mt-12" aria-label="Navigazione tra articoli" data-blog-nav="">
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <a href="i-sogni-possono-predire-il-futuro-la-sorprendente-scienza-dei-sogni-precognitivi" class="glass-panel rounded-xl p-5 flex items-start gap-3 hover:border-dream-salmon/30 transition-all hover:-translate-y-1">
      ...
      <div>
        ...
        <div class="font-serif text-lg text-dream-cream mt-1">I sogni possono predire il futuro? La scienza dei sogni precognitivi</div>
      </div>
    </a>
    <a href="sogni-sulla-morte-significato-e-interpretazione" class="glass-panel rounded-xl p-5 flex items-start justify-between gap-3 hover:border-dream-salmon/30 transition-all hover:-translate-y-1">
      <div>
