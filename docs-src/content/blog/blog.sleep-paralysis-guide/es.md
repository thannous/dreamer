...
<li class="text-purple-400">/</li>
<li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
<span class="text-dream-cream" itemprop="name">Parálisis del sueño</span>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <a href="guia-diario-suenos" class="glass-panel rounded-xl p-5 flex items-start justify-between gap-3 hover:border-dream-salmon/30 transition-all hover:-translate-y-1">
      <div>
        ...
        <div class="font-serif text-lg text-dream-cream mt-1">Diario de sueños: la guía completa para registrar tus aventuras nocturnas</div>
      </div>
