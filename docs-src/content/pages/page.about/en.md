...
<h1 class="font-serif text-4xl md:text-5xl mb-10 text-dream-cream">About Noctalia</h1>
        ...
        <div class="space-y-8 text-gray-300 leading-relaxed">
            <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
                ...
                <p><strong>Noctalia</strong> is a private <a href="blog/dream-journal-guide" class="text-dream-salmon hover:underline">dream journal</a> for people who want to save the fragile details of a dream, then explore symbols, emotions, and patterns without treating an AI answer as a diagnosis.</p>
