---
{
  ...
  "title": "Funcionalidades do Noctalia | Diário de sonhos com IA",
  "description": "Registro por voz ou texto, transcrição, interpretação de sonhos inspirada em Jung, símbolos, imagem gerada, perguntas guiadas, estatísticas e privacidade.",
  ...
  "ogType": "website",
  "ogTitle": "Funcionalidades do Noctalia",
  "ogDescription": "Tudo o que o Noctalia oferece para registrar, entender e acompanhar os seus sonhos no Android.",
  "ogImage": "https://noctalia.app/img/og/noctalia-en-1200x630.jpg",
  "ogImageAlt": "Funcionalidades do diário de sonhos Noctalia",
  "twitterCard": "summary_large_image",
  "twitterTitle": "Funcionalidades do Noctalia",
  "twitterDescription": "Tudo o que o Noctalia oferece para registrar, entender e acompanhar os seus sonhos no Android.",
...
<div class="space-y-8 text-gray-300 leading-relaxed">
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-full bg-dream-salmon/10 flex items-center justify-center flex-shrink-0">
        <i data-lucide="mic" class="w-6 h-6 text-dream-salmon"></i>
      </div>
      <div>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-full bg-dream-salmon/10 flex items-center justify-center flex-shrink-0">
        <i data-lucide="audio-lines" class="w-6 h-6 text-dream-salmon"></i>
      </div>
      <div>
        <h2 class="text-2xl font-serif text-white mb-3">Transcrição da voz em texto</h2>
        <p>O Noctalia usa primeiro o reconhecimento de voz nativo do celular. Quando ele não está disponível ou não é suficiente, o app recorre ao Google Cloud Speech-to-Text por meio do backend. O áudio serve apenas à transcrição e não é armazenado de forma duradoura pelo Noctalia: só a transcrição é conservada no seu diário.</p>
      </div>
    </div>
  </section>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-full bg-dream-salmon/10 flex items-center justify-center flex-shrink-0">
        <i data-lucide="brain-circuit" class="w-6 h-6 text-dream-salmon"></i>
      </div>
      <div>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-full bg-dream-salmon/10 flex items-center justify-center flex-shrink-0">
        <i data-lucide="image" class="w-6 h-6 text-dream-salmon"></i>
      </div>
      <div>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-full bg-dream-salmon/10 flex items-center justify-center flex-shrink-0">
        <i data-lucide="compass" class="w-6 h-6 text-dream-salmon"></i>
      </div>
      <div>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-full bg-dream-salmon/10 flex items-center justify-center flex-shrink-0">
        <i data-lucide="bar-chart-2" class="w-6 h-6 text-dream-salmon"></i>
      </div>
      <div>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-full bg-dream-salmon/10 flex items-center justify-center flex-shrink-0">
        <i data-lucide="wifi-off" class="w-6 h-6 text-dream-salmon"></i>
      </div>
      <div>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-full bg-dream-salmon/10 flex items-center justify-center flex-shrink-0">
        <i data-lucide="shield-check" class="w-6 h-6 text-dream-salmon"></i>
      </div>
      <div>
        <h2 class="text-2xl font-serif text-white mb-3">Privacidade dos seus sonhos</h2>
        <p>As suas transcrições e textos são criptografados em trânsito, e o Noctalia não revende os seus dados. Um sonho pode conter informações íntimas: a <a href="/pt-br/politica-de-privacidade" class="text-dream-salmon hover:underline">Política de Privacidade</a> detalha os dados tratados, os fornecedores e os seus direitos de exclusão.</p>
      </div>
    </div>
  </section>
