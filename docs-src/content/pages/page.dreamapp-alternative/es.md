---
{
  ...
  "title": "Alternativa a DreamApp para diario de sueños | Noctalia",
  ...
  "ogType": "article",
  "ogTitle": "Alternativa a DreamApp para diario de sueños",
  "ogDescription": "Compara DreamApp y Noctalia en interpretación de sueños, voz, precio, Android, privacidad y cuándo elegir cada diario onírico.",
  "ogImage": "https://noctalia.app/img/og/noctalia-en-1200x630.jpg",
  "ogImageAlt": "Noctalia dream journal app",
  "twitterCard": "summary_large_image",
  "twitterTitle": "Alternativa a DreamApp para diario de sueños",
  "twitterDescription": "Compara DreamApp y Noctalia en interpretación de sueños, voz, precio, Android, privacidad y cuándo elegir cada diario onírico.",
...
<div class="space-y-8 text-gray-300 leading-relaxed">
  ...
  <section class="grid md:grid-cols-2 gap-6">
    <div class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
      ...
      <p><strong>Nota de precio:</strong> DreamApp aparece como gratis con compras integradas; Google Play no muestra todo el catálogo. Noctalia muestra Gratis más Onironauta a 2,99 €/mes o 19 €/año. Los precios pueden cambiar por país, impuestos, promociones y tienda.</p>
    </div>
    <div class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    ...
    <ul class="list-disc pl-5 space-y-2">
      <li><a href="https://play.google.com/store/apps/details?id=com.dreamapp.app&hl=en-US" class="text-dream-salmon hover:underline" rel="nofollow noopener noreferrer" target="_blank">DreamApp en Google Play</a></li>
      <li><a href="https://apps.apple.com/us/app/dreamapp-dream-interpretation/id1524421486" class="text-dream-salmon hover:underline" rel="nofollow noopener noreferrer" target="_blank">DreamApp en App Store</a></li>
      ...
      <li><a href="https://noctalia.app/es/politica-privacidad" class="text-dream-salmon hover:underline">Política de privacidad de Noctalia</a></li>
