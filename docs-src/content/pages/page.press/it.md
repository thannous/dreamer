...
<p class="text-lg text-purple-200/80 leading-relaxed mb-10">Noctalia e un diario dei sogni con IA per catturare, interpretare ed esplorare i sogni con note vocali, trascrizione automatica, simboli ricorrenti, temi, immagini generate e Dream Chat.</p>
...
<div class="space-y-8 text-gray-300 leading-relaxed">
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    ...
    <p>Diario dei sogni con IA per voce, trascrizione, interpretazione, simboli, temi, immagini e Dream Chat.</p>
    <h3 class="text-white font-medium mt-6 mb-2">Descrizione lunga</h3>
    <p>Noctalia aiuta a registrare i sogni con voce o testo, ricevere interpretazioni strutturate, seguire simboli ed emozioni ricorrenti, creare immagini ispirate ai sogni e fare domande di approfondimento con Dream Chat.</p>
  </section>
