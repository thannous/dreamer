---
{
  ...
  "lang": "es",
  "slug": "prensa",
  "title": "Kit de prensa de Noctalia | Diario de sueños con IA",
  "description": "Kit de prensa de Noctalia, la app de diario de sueños con IA para grabar, transcribir, interpretar y explorar sueños.",
  ...
  "preloadImage": "",
  "jsonLd": [
    "{\n      \"@context\": \"https://schema.org\",\n      \"@type\": \"WebPage\",\n      \"name\": \"Kit de prensa de Noctalia\",\n      \"url\": \"https://noctalia.app/es/prensa\",\n      \"inLanguage\": \"es\",\n      \"about\": { \"@id\": \"https://noctalia.app/#software\" },\n      \"publisher\": { \"@id\": \"https://noctalia.app/#organization\" }\n    }"
  ],
  "activeNav": null
}
---
<h1 class="font-serif text-4xl md:text-5xl mb-6 text-dream-cream">Kit de prensa de Noctalia</h1>
<p class="text-lg text-purple-200/80 leading-relaxed mb-10">Noctalia es un diario de sueños para Android que permite grabar sueños por voz, convertirlos en entradas estructuradas y explorar símbolos, imágenes, patrones y preguntas de seguimiento en Dream Chat.</p>

<div class="space-y-8 text-gray-300 leading-relaxed">
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <h2 class="text-2xl font-serif text-white mb-4">Datos clave</h2>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    ...
    <p>Diario de sueños Android con captura de voz, reflexión con IA, símbolos, imágenes generadas y Dream Chat.</p>
    <h3 class="text-white font-medium mt-6 mb-2">Descripción larga</h3>
    <p>Noctalia ayuda a capturar un sueño antes de que se pierdan los detalles. La persona puede grabar por voz o texto, recibir una reflexión estructurada, revisar símbolos y emociones recurrentes, generar una imagen del sueño y continuar con Dream Chat.</p>
  </section>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    ...
    <p>Prensa, directorios, colaboraciones o preguntas sobre el producto: <a href="mailto:contact@noctalia.app" class="text-dream-salmon hover:underline">contact@noctalia.app</a>.</p>
  </section>
</div>
