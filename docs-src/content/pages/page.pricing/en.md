---
{
  ...
  "lang": "en",
  "slug": "pricing",
  "title": "Noctalia Pricing | Free and Plus Plans",
  "description": "Compare Noctalia's free Dreamer plan and optional Noctalia Plus subscription. Google Play shows the current price and billing options before purchase.",
  ...
  "ogType": "website",
  "ogTitle": "Noctalia plans and pricing",
  "ogDescription": "Start free and compare the optional Noctalia Plus subscription. Current local pricing is displayed by Google Play.",
  "ogImage": "https://noctalia.app/img/og/noctalia-en-1200x630.jpg",
  "ogImageAlt": "Noctalia dream journal plans and pricing",
  "twitterCard": "summary_large_image",
  "twitterTitle": "Noctalia plans and pricing",
  "twitterDescription": "Start free and compare the optional Noctalia Plus subscription. Current local pricing is displayed by Google Play.",
...
<div class="space-y-8 text-gray-300 leading-relaxed">
  <section class="grid md:grid-cols-2 gap-6">
    <div class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
      <p class="text-sm uppercase tracking-wide text-purple-300/70 mb-2">Free plan</p>
      <h2 class="text-3xl font-serif text-white mb-3">Dreamer</h2>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <h2 class="text-2xl font-serif text-white mb-4">Why this page does not publish one fixed Plus price</h2>
    <p>Google Play can present local currencies, taxes and account-specific offers. A fixed amount copied onto this website could therefore be inaccurate for you. Use the store listing or the subscription screen inside Noctalia to review the applicable price, billing period, trial or promotion, renewal terms and payment method before confirming. Installing the app does not itself create a paid subscription.</p>
  </section>
