---
{
  ...
  "lang": "fr",
  "slug": "tarifs",
  "title": "Tarifs Noctalia | Offres gratuite et Plus",
  "description": "Comparez l'offre gratuite Rêveur et l'abonnement facultatif Noctalia Plus. Google Play affiche le prix et les options applicables avant l'achat.",
  ...
  "ogType": "website",
  "ogTitle": "Offres et tarifs Noctalia",
  "ogDescription": "Commencez gratuitement et comparez l'abonnement facultatif Noctalia Plus. Le tarif local actuel est affiché par Google Play.",
  "ogImage": "https://noctalia.app/img/og/noctalia-fr-1200x630.jpg",
  "ogImageAlt": "Offres et tarifs du journal de rêves Noctalia",
  "twitterCard": "summary_large_image",
  "twitterTitle": "Offres et tarifs Noctalia",
  "twitterDescription": "Commencez gratuitement et comparez l'abonnement facultatif Noctalia Plus. Le tarif local actuel est affiché par Google Play.",
...
<p class="text-lg text-purple-200/80 leading-relaxed mb-10">Commencez avec l'offre gratuite Rêveur et passez à Plus uniquement si vous souhaitez davantage de réflexion guidée. Noctalia s'installe gratuitement sur Android. Google Play localisant les prix, taxes, périodes de facturation, conditions d'éligibilité et promotions, la boutique reste la source de référence pour le montant qui vous sera réellement facturé.</p>

<div class="space-y-8 text-gray-300 leading-relaxed">
  <section class="grid md:grid-cols-2 gap-6">
    <div class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
      <p class="text-sm uppercase tracking-wide text-purple-300/70 mb-2">Offre gratuite</p>
      <h2 class="text-3xl font-serif text-white mb-3">Rêveur</h2>
    ...
    <div class="glass-panel p-8 rounded-2xl border border-dream-salmon/30 bg-dream-salmon/5">
      <p class="text-sm uppercase tracking-wide text-dream-salmon mb-2">Abonnement facultatif</p>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
    <h2 class="text-2xl font-serif text-white mb-4">Pourquoi cette page n'affiche pas un prix Plus fixe</h2>
    <p>Google Play peut présenter une devise locale, des taxes et des offres propres à un compte. Un montant recopié sur ce site pourrait donc ne pas être exact pour vous. Consultez la fiche de la boutique ou l'écran d'abonnement dans Noctalia afin de vérifier le prix applicable, la période de facturation, un éventuel essai ou avantage promotionnel, les conditions de renouvellement et le moyen de paiement avant de confirmer. Installer l'application ne déclenche pas, à lui seul, un abonnement payant.</p>
  </section>
  ...
  <section class="glass-panel p-8 rounded-2xl border border-dream-salmon/20 bg-dream-salmon/5">
    <h2 class="text-2xl font-serif text-white mb-4">Commencer avec l'offre gratuite</h2>
    <p>Téléchargez Noctalia, enregistrez votre prochain rêve et décidez après un usage réel si Plus vous est utile. Consultez les <a href="/fr/cgu" class="text-dream-salmon hover:underline">conditions d'utilisation</a> et la <a href="/fr/politique-confidentialite" class="text-dream-salmon hover:underline">politique de confidentialité</a> pour connaître l'ensemble des règles de service et de traitement des données.</p>
    <p class="mt-4"><a href="https://play.google.com/store/apps/details?id=com.tanuki75.noctalia&amp;hl=fr" class="text-dream-salmon hover:underline" rel="nofollow noopener noreferrer" target="_blank">Voir Noctalia sur Google Play</a></p>
  </section>
</div>
