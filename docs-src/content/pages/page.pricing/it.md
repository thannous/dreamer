---
{
  ...
  "lang": "it",
  "slug": "prezzi",
  "title": "Prezzi Noctalia | Piani gratuito e Plus",
  "description": "Confronta il piano gratuito Sognatore e l'abbonamento facoltativo Noctalia Plus. Google Play mostra prezzo e opzioni applicabili prima dell'acquisto.",
  ...
  "ogType": "website",
  "ogTitle": "Piani e prezzi Noctalia",
  "ogDescription": "Inizia gratis e confronta l'abbonamento facoltativo Noctalia Plus. Google Play mostra il prezzo locale attuale.",
  "ogImage": "https://noctalia.app/img/og/noctalia-it-1200x630.jpg",
  "ogImageAlt": "Piani e prezzi del diario dei sogni Noctalia",
  "twitterCard": "summary_large_image",
  "twitterTitle": "Piani e prezzi Noctalia",
  "twitterDescription": "Inizia gratis e confronta l'abbonamento facoltativo Noctalia Plus. Google Play mostra il prezzo locale attuale.",
...
<div class="space-y-8 text-gray-300 leading-relaxed">
  <section class="grid md:grid-cols-2 gap-6">
    <div class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
      <p class="text-sm uppercase tracking-wide text-purple-300/70 mb-2">Piano gratuito</p>
