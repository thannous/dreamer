---
{
  ...
  "lang": "de",
  "slug": "preise",
  "title": "Noctalia Preise | Kostenloser Tarif und Plus",
  "description": "Vergleiche den kostenlosen Träumer-Tarif mit dem optionalen Noctalia-Plus-Abo. Google Play zeigt Preis und verfügbare Optionen vor dem Kauf.",
  ...
  "ogType": "website",
  "ogTitle": "Noctalia Tarife und Preise",
  "ogDescription": "Starte kostenlos und vergleiche das optionale Noctalia-Plus-Abo. Den aktuellen lokalen Preis zeigt Google Play.",
  "ogImage": "https://noctalia.app/img/og/noctalia-de-1200x630.jpg",
  "ogImageAlt": "Tarife und Preise des Noctalia Traumtagebuchs",
  "twitterCard": "summary_large_image",
  "twitterTitle": "Noctalia Tarife und Preise",
  "twitterDescription": "Starte kostenlos und vergleiche das optionale Noctalia-Plus-Abo. Den aktuellen lokalen Preis zeigt Google Play.",
...
<div class="space-y-8 text-gray-300 leading-relaxed">
  <section class="grid md:grid-cols-2 gap-6">
    <div class="glass-panel p-8 rounded-2xl border border-white/10 bg-white/5">
      <p class="text-sm uppercase tracking-wide text-purple-300/70 mb-2">Kostenloser Tarif</p>
      <h2 class="text-3xl font-serif text-white mb-3">Träumer</h2>
    ...
    <div class="glass-panel p-8 rounded-2xl border border-dream-salmon/30 bg-dream-salmon/5">
      <p class="text-sm uppercase tracking-wide text-dream-salmon mb-2">Optionales Abo</p>
