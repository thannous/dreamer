---
{
  ...
  "lang": "en",
  "slug": "privacy-policy",
  "title": "Privacy Policy | Noctalia",
  "description": "Noctalia privacy policy: data collected, purposes, hosting, AI providers, retention, security, and your GDPR rights.",
  ...
  "ogType": "website",
  "ogTitle": "Privacy Policy | Noctalia",
  "ogDescription": "Noctalia privacy policy: data collected, purposes, hosting, AI providers, retention, security, and your GDPR rights.",
  "ogImage": "https://noctalia.app/img/og/noctalia-en-1200x630.jpg",
  "ogImageAlt": "",
  "twitterCard": "summary_large_image",
  "twitterTitle": "Privacy Policy | Noctalia",
  "twitterDescription": "Noctalia privacy policy: data collected, purposes, hosting, AI providers, retention, security, and your GDPR rights.",
  ...
  "preloadImage": "",
  "jsonLd": [
    "{\n    \"@context\": \"https://schema.org\",\n    \"@type\": \"WebPage\",\n    \"name\": \"Privacy Policy\",\n    \"url\": \"https://noctalia.app/en/privacy-policy\",\n    \"inLanguage\": \"en\",\n    \"publisher\": {\n        \"@id\": \"https://noctalia.app/#organization\"\n    }\n}",
    "{\n            \"@context\": \"https://schema.org\",\n            \"@type\": \"BreadcrumbList\",\n            \"itemListElement\": [\n                {\n                    \"@type\": \"ListItem\",\n                    \"position\": 1,\n                    \"name\": \"Home\",\n                    \"item\": \"https://noctalia.app/\"\n                },\n                {\n                    \"@type\": \"ListItem\",\n                    \"position\": 2,\n                    \"name\": \"Privacy Policy\",\n                    \"item\": \"https://noctalia.app/en/privacy-policy\"\n                }\n            ]\n        }"
  ],
  "activeNav": null
}
---
<h1 class="font-serif text-4xl md:text-5xl mb-6 text-dream-cream">Privacy Policy</h1>
        ...
        <div class="space-y-8 text-gray-300 leading-relaxed">
            ...
            <section>
                ...
                <p>When using the Noctalia app or website, we may process the following categories of data:</p>
                <ul class="list-disc pl-5 mt-4 space-y-2">
                    ...
                    <li><strong>Technical and usage data:</strong> technical logs (errors, performance, security events), basic device information (operating system, app version), a hashed device identifier used solely for free-tier quota management, and technical identifiers necessary to provide the service. Optional app usage measurement is disabled by default and starts only after you enable it in the introduction or settings. It helps Noctalia improve navigation, first saves and return within seven days. You can use the app without agreeing and withdraw your consent at any time in settings. On Android, iOS and the web app, Noctalia may also measure a limited set of functional events (onboarding step viewed, choice made, dream saved or result viewed) using a random journey identifier kept on the device for no more than seven days. This first-party measurement never includes dream text, titles or analyses, nor an email address, account identifier, device identifier or persisted IP address. It uses no third-party marketing analytics tool and can be disabled from the introduction or settings.</li>
                    ...
                    <li><strong>Consent-based traffic measurement:</strong> solely to improve Noctalia and this website, Google Analytics measures pages viewed, traffic sources, basic interactions and technical information (browser, device, operating system, language, approximate country-level location) if you allow analytics. Google Analytics may set the <code>_ga</code> and <code>_ga_*</code> cookies. Advertising features and advertising storage remain disabled, and we do not intentionally send dream content or account data to Google Analytics.</li>
            ...
            <section>
                ...
                <p class="mt-4">Optional app usage measurement is based on your consent, independently of the technical operations needed to provide and secure the service.</p>
                ...
                <ul class="list-disc pl-5 mt-4 space-y-2">
                    ...
                    <li><strong>Measuring technical stability, preventing abuse and ensuring security:</strong> processing based on our <strong>legitimate interest</strong> in ensuring the proper functioning, security and development of the service, without marketing profiling.</li>
                    ...
                    <li><strong>Traffic measurement with Google Analytics:</strong> processing based solely on your analytics <strong>consent</strong>, which you can refuse or withdraw at any time.</li>
            ...
            <section>
                ...
                <ul class="list-disc pl-5 mt-4 space-y-2">
                    ...
                    <li><strong>Google Analytics:</strong> user-level measurement data is retained for up to 14 months; aggregated statistics may be kept for longer.</li>
            ...
            <section>
                ...
                <ul class="list-disc pl-5 mt-4 space-y-2">
                    ...
                    <li><strong>Consent-based traffic measurement:</strong> Google provides Google Analytics only after you agree. Details are available in the <a href="https://policies.google.com/privacy" class="text-dream-salmon hover:underline">Google Privacy Policy</a>.</li>
                    ...
                    <li><strong>Subscription management:</strong> RevenueCat (USA) manages in-app subscriptions. RevenueCat receives an anonymous user identifier and purchase information provided by the applicable app store, Apple App Store or Google Play. Your complete payment information never passes through Noctalia. After you delete your account, Noctalia deletes the subscription data on its side; purchase records may however be retained by Apple, Google Play and RevenueCat in accordance with their own legal obligations. Deleting your account does not cancel the subscription, which is managed in the subscription settings of the Apple App Store or Google Play.</li>
            ...
            <section>
                ...
                <ul class="list-disc pl-5 mt-4 space-y-2">
                    ...
                    <li><strong>Right to withdraw consent:</strong> where processing is based on your consent (notably for certain sensitive data), you can withdraw it at any time, without affecting the lawfulness of prior processing. You can change the Clarity and Google Analytics choice through “Analytics preferences” in the footer.</li>
                </ul>
