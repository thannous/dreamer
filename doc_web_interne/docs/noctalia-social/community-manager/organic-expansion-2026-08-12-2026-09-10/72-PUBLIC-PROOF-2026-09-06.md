# Registre des preuves publiques — 6 septembre 2026
...
Le hero reprend `NIGHT_COSMIC_STAR_OCEAN_01.mp4`.

| Plateforme et compte | Heure | Identifiant éditorial | État préparatoire | URL publique vérifiée |
|---|---:|---|---|---|
| Pinterest `@noctaliadreams` | 17:30 | Hero exact du 06/09 | **PUBLIÉ** | [1127940669219704199](https://www.pinterest.com/pin/1127940669219704199/) — titre, description, tableau `How to Remember Dreams`, UTM et label IA vérifiés ; 0 impression/enregistrement/clic au premier relevé |
| YouTube `UCQZsVAOggq_meTWYG-4dHfw` | 18:00 | `Remember This Ocean of Stars Before It Fades #Shorts` | **ÉCHEC — NON PUBLIÉ** | Aucune URL publique : la chaîne exacte `Noctalia` / `@noctaliadreams` expose 21 vidéos, la plus récente au 01/09, sans le titre attendu ; YouTube Studio expose 22 lignes dont le brouillon floral privé, mais aucune ligne du HERO du 06/09 |
| Facebook page `1266183263247451` | 18:15 | Hero exact du 06/09 | **PROGRAMMÉ — ÉCHEC — NON PUBLIÉ** | Aucune URL publique : les surfaces exactes `/NoctaliaDreams/reels` et `/NoctaliaDreams/videos` affichent « Ce contenu n’est pas disponible pour le moment » après le checkpoint de 18:45 |
