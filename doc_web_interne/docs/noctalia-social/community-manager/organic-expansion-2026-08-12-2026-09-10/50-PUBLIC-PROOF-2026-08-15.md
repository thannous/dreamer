# Registre des preuves publiques — 15 août 2026
...
Le hero reprend `07-couloir-portes-deferlement.mp4`.

| Plateforme et compte | Heure | Identifiant éditorial | État préparatoire | URL publique vérifiée |
|---|---:|---|---|---|
| Pinterest `@noctaliadreams` | 17:30 | `Dream Journal Prompt: Write the Nouns First` | **PUBLIÉ** — profil exact, vidéo 15 s, label `Modifiée par IA` et UTM ouverts le 15/08 | [Épingle publique](https://fr.pinterest.com/pin/1127940669217929058/) |
| YouTube `UCQZsVAOggq_meTWYG-4dHfw` | 18:00 | Hero exact du 15/08 | **PUBLIÉ** — chaîne, titre et label IA publics contrôlés le 15/08 | [Short public](https://www.youtube.com/shorts/4AKei6TCjDY) |
| Facebook page `1266183263247451` | 18:15 | Hero exact du 15/08 | **PUBLIÉ** — page Noctalia, hook et audience publique contrôlés le 15/08 | [Reel public](https://www.facebook.com/reel/1805440453951394) |
...
- Principal : `4/9` preuves publiques vérifiées.
- Hero secondaire : `3/3` preuves publiques vérifiées.
- Total : `7/12` preuves publiques vérifiées ; les autres lignes restent à
  contrôler après leur échéance, sans supposer leur diffusion.
