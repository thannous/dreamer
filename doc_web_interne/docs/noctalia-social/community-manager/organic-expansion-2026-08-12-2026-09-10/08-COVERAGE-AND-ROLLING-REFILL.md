...
| Instagram `@noctaliadreams` | 15:45, 19:45, 22:45 | **73/84 lignes couvertes** par une preuve `PUBLIÉE` ou `PRÊT — DIRECT` ; les 3 lignes Instagram du **14/08**, le C3 du **21/08**, le C1 et le C3 du **22/08**, le C1 du **23/08**, le C3 du **24/08**, le C2 et le C3 du **25/08**, et le C1 du **26/08** restent explicitement `ÉCHEC — NON PUBLIÉ` et ne sont pas comptés comme couverts ; les lignes futures conservées en `PRÊT — DIRECT` ne valent pas preuve publique avant leur heure | **11 lignes** à rattraper d'abord (3 du 14/08 + 21/08 C3 + 22/08 C1 et C3 + 23/08 C1 + 24/08 C3 + 25/08 C2 et C3 + 26/08 C1), puis publier chaque ligne échue et vérifier son URL publique |
