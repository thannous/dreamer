...
- preuve locale: `doc_web_interne/docs/revenuecat-qa-evidence.local.json` absent; malgre les achats Test Store locaux passes, `subscription:qa:release-gate` doit rester rouge tant que les preuves structurees restore/account-switch/Play ne sont pas renseignees
