  ...
  return (
    <LucidScreen eyebrow={copy.program} title={program.title} subtitle={program.summary} trailing={<LucidIconAction label={content.chrome.common.back} icon="close" onPress={close} />}>
      ...
      {program.sessions.map((session) => {
        ...
        return (
          // Verrouillée, la carte n'a pas d'`onPress` : son libellé doit malgré tout
          // être annoncé, et dire pourquoi elle ne répond pas. Terminée, l'état est
          // dans le libellé et non dans `checked`, qui n'a de sens que sur une case
