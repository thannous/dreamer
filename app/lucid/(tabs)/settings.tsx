...
const COPY = {
  en: {
    ...
    sync: 'Cloud sync',
    syncBody: 'Sync your observations with your Noctalia account. Sign confirmations, Atlas settings and audio stay on this device. Disabled by default.',
  ...
  fr: {
    ...
    syncBody: 'Synchronisez vos observations avec votre compte Noctalia. Les confirmations de signes, les réglages Atlas et les fichiers audio restent sur cet appareil. Désactivée par défaut.',
  ...
  es: {
    ...
    syncBody: 'Sincroniza tus observaciones con tu cuenta Noctalia. Las confirmaciones de señales, los ajustes del Atlas y el audio permanecen en este dispositivo. Desactivada por defecto.',
  ...
  de: {
    ...
    syncBody: 'Synchronisiere deine Beobachtungen mit deinem Noctalia-Konto. Zeichenbestätigungen, Atlas-Einstellungen und Audio bleiben auf diesem Gerät. Standardmäßig aus.',
  ...
  it: {
    ...
    syncBody: 'Sincronizza le osservazioni con il tuo account Noctalia. Le conferme dei segnali, le impostazioni dell’Atlante e l’audio restano su questo dispositivo. Disattivata di default.',
