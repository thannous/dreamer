...
export const PREDEFINED_DREAMS: Omit<DreamAnalysis, 'id'>[] = [
  {
    ...
    emotions: [
      { name: 'Wonder', insight: 'The endless shelves leave you awed rather than lost, which is a good sign about how you meet the unknown.' },
      { name: 'Nostalgia', insight: 'The childhood pages pull gently backwards; the dream lingers there without asking you to stay.' },
      { name: 'Quiet awe', insight: 'Nothing in the library threatens you, so the scale reads as invitation rather than pressure.' },
    ],
    theme: 'mystical',
  ...
  },
  {
    ...
    emotions: [
      { name: 'Exhilaration', insight: 'Moving freely through open space suggests a part of you that is ready for more room.' },
      { name: 'Smallness', insight: 'Vastness can shrink the self; here it seems to comfort rather than diminish.' },
      { name: 'Calm', insight: 'There is no struggle in the swimming, which points to something settled underneath.' },
    ],
    theme: 'surreal',
    dreamType: 'Symbolic Dream',
  ...
  },
  {
    ...
    emotions: [
      { name: 'Serenity', insight: 'The garden asks nothing of you, a rare state your waking days may be short of.' },
      { name: 'Relief', insight: 'Arriving somewhere gentle often follows a stretch of holding tension.' },
      { name: 'Tenderness', insight: 'What grows here is cared for, which suggests you are tending something in yourself.' },
    ],
    theme: 'calm',
  ...
  },
  {
    ...
    emotions: [
      { name: 'Apprehension', insight: 'Meeting a later version of yourself raises the question of whether you are on the way.' },
      { name: 'Curiosity', insight: 'You approach rather than avoid, which says something about your readiness.' },
      { name: 'Self-doubt', insight: 'The comparison is the point; the dream stages it so you can look at it directly.' },
    ],
    theme: 'mystical',
    dreamType: 'Symbolic Dream',
  ...
  },
  {
    ...
    emotions: [
      { name: 'Peace', insight: 'Harmony in a dream often marks a conflict that has quietly resolved.' },
      { name: 'Loneliness', insight: 'A voice needs a listener; the forest hears you before anyone else does.' },
      { name: 'Longing', insight: 'Singing reaches outward, which suggests something you want to be met.' },
    ],
    theme: 'calm',
    dreamType: 'Symbolic Dream',
