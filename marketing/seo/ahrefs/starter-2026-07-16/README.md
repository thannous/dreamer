...
- [`j1-j17-operational-history-2026-08-01.md`](https://drive.google.com/file/d/1yA4-fUA_205y3coTGzMjsKIwvtQcH8zD/view?usp=drivesdk) : historique complet, résultats, limites et points d'arrêt.
...
- [`j19-j23-operational-update-2026-08-07.md`](https://drive.google.com/file/d/13Ggy3myaM8N-TJRuvaIb-mQUsr1GlH0F/view?usp=drivesdk) : synthèse durable des relevés Rank Tracker, GSC, Site Audit, maillage interne et préparation du point de décision J24.
...
- [`j26-gsc-content-opportunities-2026-08-10.md`](https://drive.google.com/file/d/1anCxrDa4wA2nbJ5LY6XeWZSlxpbHmK09/view?usp=drivesdk) : analyse GSC `page × query` et arbitrage chef SEO ; IT en mesure, correction DE séparée, architecture DE et EN en HOLD.
...
- [`j26-new-content-summary-2026-08-10.md`](https://drive.google.com/file/d/1tSuIvEIodeXKzA9kYpAF637CxV_2AMu0/view?usp=drivesdk) : synthèse séparée confirmant zéro nouvelle page immédiate et une seule candidate IT conditionnelle.
...
- [`j26-j31-starter-utilization-plan-2026-08-10.md`](https://drive.google.com/file/d/17zWg06dqFUuKgeS4PHJhGfQI5-Hu41iK/view?usp=drivesdk) : plan de consommation contrôlée avant le reset du 16 août, avec statut d'exécution J26.
- [`j26-starter-execution-2026-08-10.md`](https://drive.google.com/file/d/1A3IpQ7m2dQ6z5Yg9KugR3FNFHZp8wgfk/view?usp=drivesdk) : résultats des Lots A à D, crawl planifié, compteurs finaux, concurrents retenus, backlog J27 et recommandation provisoire Free vs Starter.
- [`j26-competitive-keyword-gap-2026-08-10.md`](https://drive.google.com/file/d/1oMF5EqUzzULnvhX1uvAYsrZhSUjAQjpD/view?usp=drivesdk) : collecte Organic Keywords ciblée sur sept concurrents IT/DE/FR/ES, coût réel, exclusions et hypothèses à valider dans GSC.
...
- [`j27-gsc-keyword-validation-2026-08-11.md`](https://drive.google.com/file/d/1Dn1_xKz86D_C4Yvy-O9Ms0W9HPXO-loc/view?usp=drivesdk) : validation GSC 28 jours et fenêtre disponible « 12 mois », six rapports Keyword Explorer/SERP et décisions chaussures/crocodile.
...
- [`j27-ranking-expansion-2026-08-11.md`](https://drive.google.com/file/d/16U3bfEP94mezu3169ZfrHknwJ9MyP_9b/view?usp=drivesdk) : extension J27 autorisée, croisement de 80 requêtes Ahrefs avec GSC, lot de 20 routes localisées et quatre quick wins de titres existants.
...
- [`j27-ranking-expansion-execution-2026-08-11.md`](https://drive.google.com/file/d/1YDgeqnMtGUxIh2ajKatwr-RJawXMkyko/view?usp=drivesdk) : journal du chantier `turtle` → `crocodile` → `lice`, séparation des états Git/publics et portes d'autorisation des leviers différés.
- [`j28-gsc-indexation-triage-2026-08-12.md`](https://drive.google.com/file/d/1anEzXo3wy_gsI-P_xjfZFVdb6TTXQkRx/view?usp=drivesdk) : tri du premier cas parmi les 254 URL, contradiction couverture/performance GSC, lien contextuel DE publié et preuves Git/CI/Cloudflare/HTTP.
- [`j28-actionable-levers-execution-2026-08-12.md`](https://drive.google.com/file/d/1s56WwK7DV1d5kxaY66lE-92VgmikfMw2/view?usp=drivesdk) : exécution de l'optimisation `coche`, validation GSC/Ahrefs et préparation des cinq propriétaires `scorpion`, avec coût et stop-gates.
- [`j29-authority-recovery-2026-08-13.md`](https://drive.google.com/file/d/1bNOFiDwNBMl6Lx6Grj_R_Ml-xrSdUrjM/view?usp=drivesdk) : collecte durable nouveaux/perdus, pages par liens et ancres, séparation du spam et backlog d'autorité externe avec portes D2–D10A.
- [`j29-gsc-ahrefs-cluster-validation-2026-08-13.md`](https://drive.google.com/file/d/1KvhWc4ZBCPLv9lLfNTYPYuWMCJ0RWgQT/view?usp=drivesdk) : validation GSC 28 jours et fenêtre disponible des clusters guêpe/cimetière, micro-lot Ahrefs initial à cinq crédits, complément UI à quatre crédits et ordre `cemetery` puis `wasp` après la porte J+7.
...
- [`j32-catch-up-2026-08-16.md`](https://drive.google.com/file/d/10wG_BzjTROqjCVGPRNjZdIvZpwgJg6ZO/view?usp=drivesdk) : rattrapage du checkpoint J+7, reset Starter confirmé, lecture Rank Tracker/Site Audit et implémentation locale des cinq propriétaires `cemetery`, avec séparation du contrat URL et de la publication.
...
- [`j27-misabueso-gsc-ownership-2026-08-11.md`](https://drive.google.com/file/d/1sNqeCh2pRYciuWo4gvMz_CKiyGFTEUxe/view?usp=drivesdk) : baseline GSC espagnole après l'analyse Misabueso, propriétaires confirmés et plus petit lot d'ancre justifié.
- [`j27-misabueso-gsc-ownership-matrix-2026-08-11.csv`](https://drive.google.com/file/d/1UTFCeuRvT6AfnrfhRFIYQ8RwUOdPH79Y/view?usp=drivesdk) : matrice GO / ADJUST / HOLD des URL et clusters espagnols sur deux fenêtres comparables de 28 jours.
