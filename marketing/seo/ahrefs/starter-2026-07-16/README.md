...
- Validation : `docs:build` vert (1 253 pages, 53 articles × 5 langues) et tous les contrôles `docs:check` passent ; seul `check-public-url-stability` attend l'extension intentionnelle de la baseline (+15 routes) après le commit du lot.
