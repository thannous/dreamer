...
- [`j38-plan-2026-08-22.md`](./j38-plan-2026-08-22.md) : plan J38 avec checkpoint GSC J+14 de `casa`–`ragno`–`perro`, décision de publication séparée pour `escaleras`, micro-lot Starter `snail` plafonné à 8 crédits et contrôle DreamWell sans envoi.
