...
- `marketing/seo/backlink-results-2026-07-31.csv`: eighteen manually audited surfaces, including six indexable followed pages (one explicitly low-trust), seven indexable nofollow pages (one explicitly low-trust), two nonindexable profiles, one lost historical listing and two search-visible store-derived or entity-profile surfaces whose link treatment remains unverified;
...
- `marketing/seo/backlink-prospects-2026-07-31.csv`: 152 researched opportunities: 2 P0 corrections/reclamations, 51 P1 prospects, 98 P2 prospects or exclusions and 1 P3 launch route;
...
- `marketing/seo/backlink-outreach-log-2026-07-31.csv`: send, reply, follow-up and live-link state for 42 route records covering 41 unique publishers or directories, including 31 delivered, accepted, acknowledged or waiting contacts (one closed after a duplicate form attempt), 6 scheduled but not yet sent messages, 1 temporarily delayed route, 1 unconfirmed form attempt and 3 failed official routes.
