...
The professional mailbox is now available in the user-designated Chrome session. Zimbra visibly identified `DEFAULT <contact@noctalia.app>`, and one qualified free-directory submission was sent to AllThingsAI's official address. Zimbra displayed `Le mail a été envoyé.` No unrelated message content was opened for this action, and the send is recorded only as outreach awaiting review.
...
- `marketing/seo/backlink-outreach-log-2026-07-31.csv`: send, reply, follow-up and live-link state for 29 route records covering 28 unique publishers or directories, including 24 delivered or accepted contacts, 1 temporarily delayed route, 1 unconfirmed form attempt and 3 failed official routes.
...
| B — editorial wave | Twenty-eight route attempts cover twenty-seven unique publishers: twenty-three are delivered or accepted, JournPad remains temporarily delayed inside Gmail's retry window, Android Authority has one additional unconfirmed form attempt after the earlier publisher-level email, and Best Apps for Android, Know Your Ethos and Dreamz Journal failed and were closed without guessed alternatives. Frandroid and Lifehacker supplied authoritative form confirmations; Paul Hatton remains away through 2026-08-12. | Twenty-two delivered or accepted contacts remain in the scheduled follow-up pool. Android Authority may still reply to the original email, but is closed to every retry or follow-up after the deduplication miss; JournPad is also excluded until delivery is confirmed. General first follow-ups remain due on 2026-08-05; Dream Studies Portal is due on 2026-08-06; confirmed 2026-08-02 outreach is due on 2026-08-07; TechRadar is deferred to 2026-08-13. No sent or attempted message is counted as a backlink. |
