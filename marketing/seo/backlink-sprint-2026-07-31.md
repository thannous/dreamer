...
A new Gmail search after that wave found no editorial reply or delivery failure for Android Guías or SlashGear. The only delivery-status result was an older, unrelated temporary-delay notice for Searchgun. This search still covers the authenticated `thannous@gmail.com` mailbox only and says nothing about the separate `contact@noctalia.app` inbox.
...
- `marketing/seo/backlink-prospects-2026-07-31.csv`: 86 researched opportunities: 2 P0 corrections/reclamations, 35 P1 prospects, 48 P2 prospects or exclusions and 1 P3 launch route.
- `marketing/seo/backlink-outreach-wave-1-2026-07-31.md`: 24 recipient-specific editorial messages or form dossiers, current contact routes and a two-follow-up stop policy.
- `marketing/seo/backlink-outreach-log-2026-07-31.csv`: send, reply, follow-up and live-link state for 25 attempted routes, including 22 delivered or accepted and 3 failed official routes.
...
| B — editorial wave | The initial ten-target lot and the seven-target extension produced thirteen delivered emails plus accepted App Charts and Dream Studies Portal forms. Best Apps for Android, Know Your Ethos and Dreamz Journal failed on their published official routes and were closed without guessed alternatives. Paul Hatton returned an automatic away notice through 2026-08-12. | Fifteen editorial contacts are awaiting outcomes. General first follow-ups remain due on 2026-08-05; Dream Studies Portal is due on 2026-08-06; TechRadar is deferred to 2026-08-13. No sent message is counted as a backlink. |
