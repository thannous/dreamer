...
- `marketing/seo/backlink-prospects-2026-07-31.csv`: 98 researched opportunities: 2 P0 corrections/reclamations, 40 P1 prospects, 55 P2 prospects or exclusions and 1 P3 launch route.
- `marketing/seo/backlink-outreach-wave-1-2026-07-31.md`: 30 recipient-specific editorial messages or form dossiers, including the numbered sequence through 29 and replacement route 4R, with current contact routes and a two-follow-up stop policy.
