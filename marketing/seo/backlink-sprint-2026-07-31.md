...
- [ ] Send outreach wave 1 to the ten personalized editorial targets — eight email routes were reverified and sent once, and the App Charts form was accepted with an explicit success confirmation. Dream Studies Portal is the only remaining target: its vetted methodology pitch is prefilled but not submitted because reCAPTCHA is user-owned. The public CSV gate returns 200.
...
| B — editorial wave | Eight emails were sent once after same-day article, identity and official-contact verification: Android Authority `19fb9a8aa98b5d96`, Mattress Miracle `19fb9a8486dca53e`, Sleep Review `19fb9a854cbb5c16`, Oneironaut `19fb9a8611694132`, TechRadar `19fb9a8b695d4ff8`, Tom's Guide `19fb9a8c19fef0fb`, World of Lucid Dreaming `19fb9aee937105e6`, Best Apps for Android `19fb9afacdc85285`. App Charts accepted its factual contact form with an explicit success confirmation. | Nine of ten routes are now sent or submitted and awaiting replies; first follow-up is not due before 2026-08-05. Dream Studies Portal remains prefilled but unsent because reCAPTCHA is user-owned. |
