...
- `marketing/seo/backlink-prospects-2026-07-31.csv`: 139 researched opportunities: 2 P0 corrections/reclamations, 46 P1 prospects, 90 P2 prospects or exclusions and 1 P3 launch route;
...
- `marketing/seo/backlink-outreach-log-2026-07-31.csv`: send, reply, follow-up and live-link state for 37 route records covering 36 unique publishers or directories, including 30 delivered, accepted, acknowledged or waiting contacts (one closed after a duplicate form attempt), 2 scheduled but not yet sent messages, 1 temporarily delayed route, 1 unconfirmed form attempt and 3 failed official routes.
