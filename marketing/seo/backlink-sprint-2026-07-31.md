...
- `marketing/seo/editorial-discovery-wave-25-2026-08-04.md`: qualified AITrendTool as a P1 independent AI-directory draft-only route, kept the already-sent AllThingsAI route waiting, and held AI Tool Lab because submissions are paused; no new email or form action was made.
...
- `marketing/seo/editorial-discovery-wave-27-2026-08-04.md`: rechecked the current Italian AndroidAyuda article but closed the route after the existing Google Group bounce, and qualified Everyeye as one P1 Italian editorial draft-only route; no new message or form action was made.
- `marketing/seo/backlink-public-asset-deployment-check-2026-08-04.md`: source and edge reconciliation found the English press asset current but French, Spanish, German and Italian press pages still serving 10 July at the public Cloudflare edge; no manual production deployment or outreach claim was made.
...
- `marketing/seo/backlink-outreach-log-2026-07-31.csv`: send, reply, follow-up and live-link state for 47 route records covering 46 unique publishers or directories: the two Xataka Android/Andro4all messages are now `initial_sent_waiting`, with all other states stored row-by-row in the CSV.
