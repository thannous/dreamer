...
| Extra free-directory batch | Submitted | Added SpotFreeAI and JunkStartups without creating any password-managed account or adding reciprocal badges. Both are pending approval, so backlink value must be verified only after public pages exist. |
