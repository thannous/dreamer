...
tools: Bash, Glob, Grep, Read, Edit, Write, NotebookEdit, WebFetch, TodoWrite, WebSearch, BashOutput, Skill, SlashCommand, mcp__morph-mcp__edit_file, mcp__morph-mcp__warpgrep_codebase_search, mcp__expo-mcp__add_library, mcp__expo-mcp__search_documentation, mcp__expo-mcp__generate_agents_md, mcp__expo-mcp__learn, mcp__expo-mcp__expo_router_sitemap, mcp__expo-mcp__open_devtools, mcp__expo-mcp__collect_app_logs, mcp__expo-mcp__automation_tap, mcp__expo-mcp__automation_take_screenshot, mcp__expo-mcp__automation_find_view, mcp__expo-mcp__generate_claude_md
model: opus
color: yellow
---
