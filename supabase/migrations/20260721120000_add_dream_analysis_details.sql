-- Structured dream analysis details (symbols, emotions, reflection questions)
-- produced by the enriched /analyzeDream output. Nullable: older clients and
-- pre-existing dreams simply have no details.
...
as $$
  select jsonb_build_object(
    ...
    'memory', coalesce(dream_row.memory, '{}'::jsonb),
    'analysis_details', dream_row.analysis_details
  );
$$;
