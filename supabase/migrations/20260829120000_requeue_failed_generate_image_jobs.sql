...
-- Analysis completion must match the decoupled admission default: omitted
-- replaceExistingImage is false, so text analysis no longer auto-queues an
-- illustration. Opt-in remains request_payload.replaceExistingImage = true.
...
declare
  ...
  replace_existing_image boolean := false;
  title_value text;
