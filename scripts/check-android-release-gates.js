...
function checkAndroidReleaseGates({
  ...
  addCheck(
    ...
    'Upload an AAB, connect a physical tester device, install via Play Internal Testing, run npm run android:play-qa-device -- --device <adb-id>, then test offering load, purchase, and restore.'
  );
