...
function checkAndroidReleaseGates({
  ...
  addCheck(
    ...
    'Purchase/restore validation requires a signed build installed from Play Internal Testing.',
    'Upload an AAB, install via Play Internal Testing, then test offering load, purchase, and restore.'
  );
