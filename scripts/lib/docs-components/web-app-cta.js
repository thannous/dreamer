const { conversionLinkAttributes } = require('./conversion-link');
...
function renderBlogWebAppCta({ lang, locale, pageId, pagePath = '' }) {
...
function renderBlogWebAppCtaModule({ bodyHtml, lang, locale, pageId, pagePath }) {
  return insertBlogWebAppCta(bodyHtml, renderBlogWebAppCta({ lang, locale, pageId, pagePath }));
}
